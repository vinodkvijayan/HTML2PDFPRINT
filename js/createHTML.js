...
// Build paths
const { buildPathdynamicHtml } = require('./buildPaths');
...
try {
	...
	if (doesFileExist(buildPathdynamicHtml)) {
		console.log('Deleting old build file');
		/* If the file exists delete the file from system */
		fs.unlinkSync(buildPathdynamicHtml);
	}
	/* generate rows */
	...
	fs.writeFileSync(buildPathdynamicHtml, html);
